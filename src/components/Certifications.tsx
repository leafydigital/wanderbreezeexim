...
const Certifications: React.FC = () => {
  ...
  const exportCerts = certifications.filter(cert =>
    ['APEDA', 'IEC', 'LUT'].includes(cert.name)
  );

  const complianceCerts = certifications.filter(cert =>
    ['GST Registration', 'FSSAI Central License'].includes(cert.name)
  );
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Certified and compliant exporter meeting global standards for agricultural and food products.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {complianceCerts.map(renderCard)}
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-gray-50 p-6 rounded-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              We maintain active registrations with FSSAI, APEDA, and other relevant authorities. 
