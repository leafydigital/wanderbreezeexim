...
// Images served from public/Images/ (no import needed — use direct paths)
const cardamom    = '/Images/Cardamom.png';
const blackPepper = '/Images/Pepper.png';
const onion       = '/Images/Onion.png';
const coconut     = '/Images/Coconut.png';
const banana      = '/Images/Banana.png';
const cocopeat    = '/Images/coco-peats.png';
const sweetpotato = '/Images/Sweetpotato.png';
const yellowpumpkin = '/Images/Pumpkin.png';
