...
const cardamomImage = '/Images/Cardamom.png';
        ...
        <div className="bg-gray-50 relative">
            ...
            <section className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                        Bulk Green Cardamom Export from Kerala (India)
                    </h1>

                    <p className="mt-6 text-lg text-gray-600">
                        8mm Bold & Premium Grades | Ready Stock | Direct Export Supply
                    </p>
                ...
                <div>
                    <img
                        src={cardamomImage}
                        alt="Kerala Green Cardamom Export"
            ...
            <section className="py-16 px-6 bg-white text-center">
                ...
                <div className="mt-8 grid md:grid-cols-3 gap-6 text-gray-700">
                    ...
                    <p>✔ Retail Brands & Private Label Buyers</p>
                </div>
            </section>
            ...
            <section className="py-16 px-6 bg-gray-50">
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
                    ...
                    {[
                        ["Origin", "Idukki, Kerala (Western Ghats)"],
                        ["MOQ", "500 KG"],
            ...
            <section className="py-20 px-6 bg-gradient-to-r from-green-600 to-blue-600 text-white text-center">
                ...
                <div className="mt-8 space-y-2 text-lg">
                    <p>5kg / 10kg Vacuum Packs</p>
                    <p>Export Cartons / Jute Bags</p>
                    <p>MOQ: 500 KG</p>
            ...
            <section className="py-20 text-center bg-gradient-to-r from-blue-600 to-green-600 text-white">
                ...
                <h2 className="text-3xl font-bold">
                    Ready to Import Cardamom from India?
                </h2>

                <p className="mt-4">
                    Get price, packing video & shipment schedule instantly
                </p>
...
export default CardamomExportFromIndia;